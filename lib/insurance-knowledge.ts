...
export const PROMPT_QUOTE_MASTER = `
 ...
 2. PRECIOS INDIVIDUALES: Si la tabla muestra una columna de "PRIMA" o "PRECIO", extrae el valor monetario de cada cobertura.
 3. DEDUCIBLES PRECISOS: Si la tabla menciona un deducible (ej. 5%, 10%, 1500 pesos) para una cobertura, regístralo exactamente.
 4. ANÁLISIS OMNI: Genera un párrafo de 3 a 4 líneas llamado "omni_analysis". Debe ser un texto persuasivo, dirigido al cliente, destacando por qué esta opción es sólida.
 ...
 ESTRUCTURA JSON OBLIGATORIA:
 {
   ...
   "coverages": [
     { "name": "Nombre Cobertura", "limit": "Suma Asegurada", "deductible": "Deducible específico si hay", "price": 0.0 }
   ]
 }
